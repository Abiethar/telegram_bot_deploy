...
async def generate_answer(user_input: str) -> str:
  ...
  model = ChatGoogleGenerativeAI(model="gemini-2.0-flash-exp",google_api_key="AIzaSyCTWU4EWjxo3LjnPZZvC0dPMX098tkSOP0",temperature=0.2,max_tokens=None)
  ...
  if user_input.lower() == "restart":
      ...
      answer = conversational_rag_chain.invoke({'input': user_input},
